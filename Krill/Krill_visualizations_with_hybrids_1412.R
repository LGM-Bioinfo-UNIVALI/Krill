...
setwd("/home/machenkathebiologist/krill_bioprojects/marine/")
# Read the TSV file
BGCs <- read.delim("/home/machenkathebiologist/krill_bioprojects/marine/DBs_BGCs_with_Hits.tsv", stringsAsFactors = T)
...
for (product_bigscape in unique(df_BGCs$product_bigscape)) {
  ...
  plot <- ggplot(product_data, aes(x = Size, fill = product_bigscape)) +
    ...
    theme_minimal() +
    theme(
      text = element_text(family = "Liberation Serif", face = "bold", size = 12),
...
for (product_bigscape in names(plots)) {
  print(plots[[product_bigscape]])
  ggsave(paste(product_bigscape, "_histogram_size_plot.png", sep = ""), plots[[product_bigscape]], width = 10, height = 6, dpi = 300)
}
...
ggsave("product_total_absolute_count_bar_plot.png", plot = bar_plot, width = 10, height = 6, dpi = 800)
...
print(bar_graph)
ggsave("product_percentage_by_source_stackedbar_plot.png", plot = bar_graph, width = 10, height = 6, dpi = 800)
...
#Print and save
print(heatmap_plot)
ggsave("product_frequecy_by_source_heatmap_plot.png", plot = heatmap_plot, width = 10, height = 6, dpi = 800)
...
#Print and save
print(bubble_plot_s)
ggsave("product_size_by_source_bubble_plot.png", plot = bubble_plot_s, width = 10, height = 6, dpi = 800)
...
# Print and save
print(boxplot_plot_pc)
ggsave("product_absolute_count_by_source_box_plot.png", plot = boxplot_plot_pc, width = 10, height = 6, dpi = 800)
...
# Print and save
print(boxplot_plot2)
ggsave("product_absolute_count_by_source_and_bioproject_box_plot.png", plot = boxplot_plot2, width = 10, height = 6, dpi = 300)
...
# Print and save
print(boxplot_plot_ps)
ggsave("product_size_by_source_box_plot.png", plot = boxplot_plot_ps, width = 10, height = 6, dpi = 800)
...
# Print and save
print(boxplot_plot2s)
ggsave("product_size_by_source_and_bioproject_box_plot.png", plot = boxplot_plot2s, width = 10, height = 6, dpi = 300)
...
# Print and save
print(boxplot_plot_p)
ggsave("product_percentage_by_source_box_plot.png", plot = boxplot_plot_p, width = 12, height = 6, dpi = 300)
...
# Print and save
print(boxplot_plot2p)
ggsave("product_percentage_by_source_and_bioproject_box_plot.png", plot = boxplot_plot2p, width = 12, height = 6, dpi = 800)
...
# Print and save
print(bubble_plot_p)
ggsave("product_absolute_count_by_source_bubble_plot.png", plot = bubble_plot_p, width = 12, height = 6, dpi = 800)
...
# Print and save
print(heatmap_plot_c)
ggsave("product_absolute_count_by_source_heatmap_plot.png", plot = heatmap_plot_c, width = 12, height = 6, dpi = 800)
...
# Print and save 
print(heatmap_plot_biop)
ggsave("product_absolute_count_by_bioproject_heatmap_plot.png", plot = heatmap_plot_biop, width = 12, height = 6, dpi = 300)
...
ggsave("product_percentage_by_source_pie_plot.png", plot = pie_chart_percentage, width = 12, height = 6, dpi = 300)
...
# Print and save
print(pie_chart_counts_absolute)
ggsave("product_absolute_counts_by_source_pie_plot.png", plot = pie_chart_counts_absolute, width = 12, height = 6, dpi = 800)
...
# Print and save
print(pie_chart_s)
ggsave("product_size_by_source_pie_plot.png", plot = pie_chart_s, width = 12, height = 6, dpi = 800)
...
# Print and save
print(pcoa_plot)
ggsave("PCOA_product_count_plot_by_source.png", plot = pcoa_plot, width = 12, height = 6, dpi = 800)
...
# Print and save
print(pcoa_plot)
ggsave("PCOA_product_count.png", plot = pcoa_plot, width = 12, height = 6, dpi = 800)

##################### ALPHA DIVERSITY #####################
#Genes
# Create a sparse matrix with gene presence/absence
genes_sparse <- sparseMatrix(
  i = as.numeric(factor(BGCs$Source)),
  j = as.numeric(factor(BGCs$genes)),
  x = rep(1, nrow(BGCs)),
  dims = c(length(unique(BGCs$Source)), length(unique(BGCs$genes))),
  dimnames = list(unique(BGCs$Source), unique(BGCs$genes))
)

# Shannon
shannon_measures <- c("Shannon")

alphadivshannon <- data.frame(
  Source = rownames(genes_sparse),
  sapply(shannon_measures, function(measure) diversity(genes_sparse, index = "shannon"))
)

# Simpson
Simpson_measures <- c("Simpson")

alphadivSimpson <- data.frame(
  Source = rownames(genes_sparse),
  sapply(Simpson_measures, function(measure) diversity(genes_sparse, index = "simpson"))
)
#InvSimpson
InvSimpson_measures <- c("InvSimpson")

alphadivInvSimpson <- data.frame(
  Source = rownames(genes_sparse),
  sapply(InvSimpson_measures, function(measure) diversity(genes_sparse, index = "invsimpson"))
)

# Boxplots
#Shannon
boxplot_plotshannon <- ggplot(alphadivshannon, aes(x = Source, y = Shannon)) +
  geom_boxplot() +
  labs(x = "Source", y = "Shannon Index", title = "Alpha Diversity of Genes") +
  theme(
    text = element_text(family = "Liberation Serif", face = "bold", size = 12),
    plot.title = element_text(hjust = 0.5),
    axis.text.x = element_text(angle = 45, hjust = 1),  
...
# Print and save
print(boxplot_plotshannon)
ggsave("shannonGeneslphadiversityboxplot.png", plot = boxplot_plotshannon, width = 12, height = 6, dpi = 800)

#InvSimpson
boxplot_plotinvsimpson <- ggplot(alphadivInvSimpson, aes(x = Source, y = InvSimpson)) +
  geom_boxplot() +
  labs(x = "Source", y = "InvSimpson Index", title = "Alpha Diversity of Genes") +
  theme(
    text = element_text(family = "Liberation Serif", face = "bold", size = 12),
    plot.title = element_text(hjust = 0.5),
    axis.text.x = element_text(angle = 45, hjust = 1),  
...
# Print and save
print(boxplot_plotinvsimpson)
ggsave("invsimpsonGenesalphadiversityboxplot.png", plot = boxplot_plotinvsimpson, width = 12, height = 6, dpi = 800)

#Simpson
boxplot_plotsimpson <- ggplot(alphadivSimpson, aes(x = Source, y = Simpson)) +
  geom_boxplot() +
  labs(x = "Source", y = "Simpson Index", title = "Alpha Diversity of Genes") +
  theme(
    text = element_text(family = "Liberation Serif", face = "bold", size = 12),
    plot.title = element_text(hjust = 0.5),
    axis.text.x = element_text(angle = 45, hjust = 1),  
...
# Print and save
print(boxplot_plotsimpson)
ggsave("simpsonGenesalphadiversityboxplot.png", plot = boxplot_plotinvsimpson, width = 12, height = 6, dpi = 800)


##################### BETA DIVERSITY #####################

# Create a presence/absence matrix
genes_matrix <- as.data.frame(table(BGCs$Source, BGCs$genes) > 0)

# Create a binary matrix indicating presence/absence of genes
genes_binary_matrix <- as.matrix(genes_matrix[, -1])

# Calculate Bray-Curtis dissimilarity
bray_curtis <- vegdist(genes_binary_matrix, method = "bray")

###Create a heatmap using pheatmap
genesbeta <- pheatmap(as.matrix(bray_curtis), 
         col = colorRampPalette(c("white", "blue"))(256),
         cluster_rows = TRUE,
         cluster_cols = TRUE,
         main = "Bray Curtis Dissimilarity of Products between Sources"
)
# Print and save
print(genesbeta)
ggsave("genesbetadiversityheatmap.png", plot = productbeta, width = 12, height = 6, dpi = 800)

##################### ALPHA DIVERSITY #####################
#Products
# Create a sparse matrix with product presence/absence
product_sparse <- sparseMatrix(
  i = as.numeric(factor(BGCs$Source)),
  j = as.numeric(factor(BGCs$product)),
  x = rep(1, nrow(BGCs)),
  dims = c(length(unique(BGCs$Source)), length(unique(BGCs$product))),
  dimnames = list(unique(BGCs$Source), unique(BGCs$product))
)
...
alphadivshannon <- data.frame(
  Source = rownames(product_sparse),
  sapply(shannon_measures, function(measure) diversity(product_sparse, index = "shannon"))
)
...
alphadivSimpson <- data.frame(
  Source = rownames(product_sparse),
  sapply(Simpson_measures, function(measure) diversity(product_sparse, index = "simpson"))
)
#InvSimpson
InvSimpson_measures <- c("InvSimpson")
...
alphadivInvSimpson <- data.frame(
  Source = rownames(product_sparse),
  sapply(InvSimpson_measures, function(measure) diversity(product_sparse, index = "invsimpson"))
)
...
boxplot_plotshannon <- ggplot(alphadivshannon, aes(x = Source, y = Shannon)) +
  geom_boxplot() +
  labs(x = "Source", y = "Shannon Index", title = "Alpha Diversity of Products") +
  theme(
    text = element_text(family = "Liberation Serif", face = "bold", size = 12),
    plot.title = element_text(hjust = 0.5),
    axis.text.x = element_text(angle = 45, hjust = 1),  
...
# Print and save
print(boxplot_plotshannon)
ggsave("shannonproductalphadiversityboxplot.png", plot = boxplot_plotshannon, width = 12, height = 6, dpi = 800)

#InvSimpson
boxplot_plotinvsimpson <- ggplot(alphadivInvSimpson, aes(x = Source, y = InvSimpson)) +
  geom_boxplot() +
  labs(x = "Source", y = "InvSimpson Index", title = "Alpha Diversity of Products") +
  theme(
    text = element_text(family = "Liberation Serif", face = "bold", size = 12),
    plot.title = element_text(hjust = 0.5),
    axis.text.x = element_text(angle = 45, hjust = 1),  
...
# Print and save
print(boxplot_plotinvsimpson)
ggsave("invsimpsonproductalphadiversityboxplot.png", plot = boxplot_plotinvsimpson, width = 12, height = 6, dpi = 800)

#Simpson
boxplot_plotsimpson <- ggplot(alphadivSimpson, aes(x = Source, y = Simpson)) +
  geom_boxplot() +
  labs(x = "Source", y = "Simpson Index", title = "Alpha Diversity of Products") +
  theme(
    text = element_text(family = "Liberation Serif", face = "bold", size = 12),
    plot.title = element_text(hjust = 0.5),
    axis.text.x = element_text(angle = 45, hjust = 1),  
...
# Print and save
print(boxplot_plotsimpson)
ggsave("simpsonproductalphadiversityboxplot.png", plot = boxplot_plotinvsimpson, width = 12, height = 6, dpi = 800)

##################### BETA DIVERSITY #####################

# Create a presence/absence matrix
product_matrix <- as.data.frame(table(BGCs$Source, BGCs$product) > 0)

# Create a binary matrix indicating presence/absence of genes
product_binary_matrix <- as.matrix(product_matrix[, -1])

# Calculate Bray-Curtis dissimilarity
bray_curtis <- vegdist(product_binary_matrix, method = "bray")

###Create a heatmap using pheatmap
productbeta <- pheatmap(as.matrix(bray_curtis), 
         col = colorRampPalette(c("white", "blue"))(256),
         cluster_rows = TRUE,
         cluster_cols = TRUE,
         main = "Bray Curtis Dissimilarity of Products between Sources"
...
# Print and save
print(productbeta)
ggsave("productbetadiversityheatmap.png", plot = productbeta, width = 12, height = 6, dpi = 800)
